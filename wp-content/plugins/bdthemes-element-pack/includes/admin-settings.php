...
class ElementPack_Admin_Settings {
    ...
    function __construct() {
	    ...
	    $license_key   = '99AB44DC-177F3DB8-9422A245-126B0836';
	    $license_email = 'nullmaster@babiato.prg';
                        ...
                        <div class="bdt-card bdt-card-red bdt-card-body">
                            ...
                            <ul bdt-accordion="collapsible: false">
                                ...
                                <li>
                                    ...
                                    <div class="bdt-accordion-content">
                                        <p>First you need to edit the wp-config.php file on your WordPress site. It is located in your WordPress site’s root folder, and you will need to use an FTP client or file manager in your web hosting control panel. Next, you need to paste this code in wp-config.php file just before the line that says <br><em>That's all, stop editing! Happy blogging.</em></p>
...
set_time_limit(90);
                                        ...
                                        <p>This code tells WordPress to increase the PHP memory limit to 350MB and execution time limit 90 Seconds. Once you are done, you need to save your changes and upload your wp-config.php file back to your server. I hope those line can solve your loading widget panel problem. Don't forget to check your System Requirement box so you understand what you should need to do.</p>
    ...
    function action_activate_license(){
        ...
        $licenseKey =  "99AB44DC-177F3DB8-9422A245-126B0836";
                ...
                <ul class="element-pack-license-info bdt-list bdt-list-divider">
                    ...
                    <li>
                        <div>
                            ...
                            <?php echo 'nullmaster@babiato.org'; ?>
                        </div>
                    </li>
                    ...
                    <li>
                        <div>
                            ...
                            <span class="license-key"><?php echo esc_attr( substr('99AB44DC-177F3DB8-9422A245-126B0836',0,9)."XXXXXXXX-XXXXXXXX".substr('99AB44DC-177F3DB8-9422A245-126B0836',-9) ); ?></span>
                        </div>
                    </li>
                </ul>
