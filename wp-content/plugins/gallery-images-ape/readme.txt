...
Gallery Images Ape - responsive photo gallery grid with advanced options. Photo gallery view. Simple image edit tool and slider view
...
In admin section left side menu select Theme section where possible to create unlimited amount of different themes. It's possible to use differenet type themes: slider and grid. 
...
In current version possible to select vertival or horizontal direction of the slider animation.

= Which pagination modes avaliable in slider? =
