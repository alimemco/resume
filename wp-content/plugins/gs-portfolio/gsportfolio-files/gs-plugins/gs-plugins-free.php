...
if( ! class_exists( 'GSPlugins_portf_free' ) ){
    
    class GSPlugins_portf_free{
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GSPlugins_portf_free ) {
                self::$_instance = new GSPlugins_portf_free();
            }
        ...
        public function gs_plugins_free_menu() {
            ...
            add_submenu_page( 
                ...
                'manage_options', 
                'gs-plugins-free', 
                array( $this, 'gsportf_free_menu_cb' )
                );
        }
        
        public function gsportf_free_menu_cb() { ?>	  
    ...
    $gsplugin_free = GSPlugins_portf_free::get_instance();
}