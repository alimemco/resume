...
function gs_portf_help_menu() {
	...
	add_submenu_page( 
	    ...
	    'manage_options', 
	    'gs-portfolio-help', 
	    'gs_portfolio_help_menu_cb'
	);
}

add_action('admin_menu', 'gs_portf_help_menu');

function gs_portfolio_help_menu_cb() {
	?>

    <div class="gs-wrap">
        
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 50px; text-align: center;">
	        <h1>GS Filterable Portfolio by GS Plugins</h1>
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsplugins.com/product/gs-portfolio" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://portfolio.gsplugins.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://portfolio.gsplugins.com/documentation" target="_blank">Documentation</a>
    			<a class="gstm-hlp-btn gstm-btn-4" href="http://portfolio.gsplugins.com/documentation/#GS_Portfolio8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
